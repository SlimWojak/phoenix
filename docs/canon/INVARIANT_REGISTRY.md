# INVARIANT_REGISTRY.yaml — a8ra v0.1
...
tier_2_subsystem:
  ...
  total_passing: "1716 tests (25 xfailed, 0 failures)"
  ...
  reason: "Tests ARE the registry. 94 files, 1716 assertions. Enumeration is post-v0.1 polish."
...
summary:
  ...
  total: "154+ invariants frozen (150 at v0.1 SEAL + 4 S51 DRIVESHAFT)"
  proof: "1716 tests, 264 chaos vectors, 94 INV-enforcing test files"
```
