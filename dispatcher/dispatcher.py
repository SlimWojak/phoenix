...
class WorkerRegistry:
    ...
    def deregister(self, worker_id: WorkerId) -> Optional[WorkerInfo]:
        """Deregister a worker."""
        with self._lock:
...
class Dispatcher(GovernanceInterface):
    ...
    def __init__(self, config: Optional[DispatcherConfig] = None):
        ...
        # Callbacks
        self._on_worker_crash: Optional[Callable[[WorkerId], None]] = None
    ...
    def start(self) -> bool:
        ...
        try:
            ...
            if not init_result.success:
                logger.error(f"Dispatcher init failed")
                return False
    ...
    def get_worker_status(self, worker_id: WorkerId) -> Optional[WorkerInfo]:
        """Get worker status."""
    ...
    def _on_heartbeat_status_change(
        self,
        worker_id: WorkerId,
