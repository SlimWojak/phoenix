...
class HaltBlockedError(Exception):
    ...
    def __init__(self, action: str, halt_id: str):
        ...
        super().__init__(
            f"Action '{action}' blocked by halt signal {halt_id}"
        )
...
class HaltGate:
    ...
    def __init__(self, halt_signal_fn: Callable[[], bool]):
        ...
        self._last_check: Optional[HaltCheckResult] = None
        self._action_attempted: Optional[str] = None
    ...
    def get_last_check(self) -> Optional[HaltCheckResult]:
