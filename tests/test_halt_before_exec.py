...
class TestHaltBeforeExec:
    ...
    def test_halted_blocks_action(self):
        ...
        from execution import HaltBlockedError, HaltGate
...
class TestExecutionGateCoordinator:
    ...
    def test_intent_passes_when_not_halted(self):
        ...
        from execution import Direction, ExecutionGateCoordinator, IntentFactory
        ...
        intent = factory.create_entry_intent(
            symbol="EURUSD", direction=Direction.LONG, size=0.01, state_hash="abc123"
        )
...
class TestHaltGatedDecorator:
    ...
    def test_decorator_enforces_check(self):
        ...
        from execution import HaltBlockedError, HaltGate, halt_gated
